...
/* harmony import */ var _example_modal_example_modal_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../example-modal/example-modal.page */ "./src/app/example-modal/example-modal.page.ts");
...
var HomePageModule = /** @class */ (function () {
    ...
    HomePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_home_page__WEBPACK_IMPORTED_MODULE_6__["HomePage"], _example_modal_example_modal_page__WEBPACK_IMPORTED_MODULE_7__["ExampleModalPage"]],
            entryComponents: [_example_modal_example_modal_page__WEBPACK_IMPORTED_MODULE_7__["ExampleModalPage"]]
        })
    ], HomePageModule);
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>\n    <ion-title>\n      Home\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n    <ion-card class=\"welcome-card\">\n      <ion-img src=\"/assets/sonatrach_logo.svg\"></ion-img>\n      <ion-card-header>\n        <!--ion-card-subtitle>Get Started</ion-card-subtitle-->\n        <ion-card-title>Dashboard</ion-card-title>\n      </ion-card-header>\n      <ion-card-content>\n        <p>This application gives you an overview of the status of database servers.</p>\n      </ion-card-content>\n    </ion-card>\n    <ion-list lines=\"none\">\n      <ion-list-header>\n        <!--ion-label>Les serveurs</ion-label-->\n        <!--h2>Les serveurs</h2-->\n      </ion-list-header>\n      <ul>\n        <li><b>Development  Servers</b></li>\n          <ion-grid>\n            <ion-row class=\"ion-justify-content-center\">\n              <ion-col class=\"ion-align-self-start server-background\" *ngFor=\"let dummy of ' '.repeat(7).split(''), let x = index, let name of name_dev\">\n                  <ion-img src=\"/assets/desktop.png\"></ion-img>\n                  <ion-img src=\"/assets/database.png\" (click)=\"databaseHistory(x + 1)\"></ion-img>\n                  <ion-img id=\"bk1\" src=\"/assets/backup.png\" (click)=\"databaseBackups($this, x + 1)\"></ion-img>\n              </ion-col>\n            </ion-row>\n            <ion-row class=\"ion-justify-content-center\">\n                <ion-col *ngFor=\"let name of name_dev\">\n                    <p>{{ name }}</p>\n                </ion-col>\n            </ion-row>\n          </ion-grid>\n        <li><b>Production Servers</b></li>\n        <ion-grid>\n            <ion-row class=\"ion-justify-content-center\">\n              <ion-col class=\"ion-align-self-start server-background\" *ngFor=\"let dummy of ' '.repeat(6).split(''), let x = index\">\n                  <ion-img src=\"/assets/desktop.png\"></ion-img>\n                  <ion-img src=\"/assets/database.png\" (click)=\"databaseHistory(x + 8)\"></ion-img>\n                  <ion-img id=\"bk2\" src=\"/assets/backup.png\" (click)=\"databaseBackups($this, x + 8)\"></ion-img>\n              </ion-col>\n            </ion-row>\n            <ion-row class=\"ion-justify-content-center\">\n                <ion-col *ngFor=\"let name of name_prod\">\n                    <p>{{ name }}</p>\n                </ion-col>\n            </ion-row>\n          </ion-grid>\n      </ul>\n      <!--ion-row>\n          <ion-item>\n              <ion-img src=\"/assets/desktop.png\" style=\"height:40px;width:45px;background-color:#92D050\"></ion-img>\n              <br />\n              <ion-label>Ionic Documentation</ion-label>\n            </ion-item>\n      </ion-row-->\n      <!--ion-item>\n        <h2 slot=\"start\">Les bases de données</h2>\n        <ion-button class=\"add\" slot=\"end\" item-right icon-right padding=\"30px\" margin=\"15px\" color=\"primary\" (click)=\"addEntry()\">\n              Afficher l'historique\n        </ion-button>\n     </ion-item>\n\n    <ion-row>\n     <ion-card id=\"prod_card\">\n      <ion-item>\n        <ion-icon name=\"desktop\" slot=\"start\"></ion-icon>\n        <ion-label>Environnement de Développement</ion-label>\n        <ion-button fill=\"outline\" slot=\"end\">Voir plus de détails</ion-button>\n      </ion-item>\n      <h3>\n        Disponibilité : {{ avail_dev }} / 7\n      </h3>\n    </ion-card>\n    \n    <ion-card id=\"dev_card\">\n      <ion-item>\n        <ion-icon name=\"desktop\" slot=\"start\"></ion-icon>\n        <ion-label>Environnement de Production</ion-label>\n        <ion-button fill=\"outline\" slot=\"end\">Voir plus de détails</ion-button>\n      </ion-item>\n      <h3>\n        Disponibilité : {{ avail_prod }} / 6\n      </h3>\n    </ion-card>\n  </ion-row-->\n      <!--ion-item href=\"https://ionicframework.com/docs/\">\n        <ion-icon slot=\"start\" color=\"medium\" name=\"book\"></ion-icon>\n        <ion-label>Ionic Documentation</ion-label>\n      </ion-item>\n      <ion-item href=\"https://ionicframework.com/docs/building/scaffolding\">\n        <ion-icon slot=\"start\" color=\"medium\" name=\"build\"></ion-icon>\n        <ion-label>Scaffold Out Your App</ion-label>\n      </ion-item>\n      <ion-item href=\"https://ionicframework.com/docs/layout/structure\">\n        <ion-icon slot=\"start\" color=\"medium\" name=\"grid\"></ion-icon>\n        <ion-label>Change Your App Layout</ion-label>\n      </ion-item>\n      <ion-item href=\"https://ionicframework.com/docs/theming/basics\">\n        <ion-icon slot=\"start\" color=\"medium\" name=\"color-fill\"></ion-icon>\n        <ion-label>Theme Your App</ion-label>\n      </ion-item-->\n    </ion-list>\n</ion-content>\n"
...
module.exports = "ion-col ion-img:nth-child(2n + 1) {\n  margin-top: 10px;\n  height: 60px;\n  width: 67px; }\n\n#prod_card, #dev_card {\n  width: 48%;\n  height: 180px;\n  color: white; }\n\n.welcome-card ion-img {\n  max-height: 35vh;\n  overflow: hidden;\n  height: 100px;\n  background-color: #f5821f; }\n\nh3 {\n  text-align: center;\n  margin-top: 9%; }\n\nion-col ion-img:nth-child(3n + 2) {\n  position: relative;\n  top: -50px;\n  left: 63px;\n  height: 60px;\n  width: 49px;\n  cursor: pointer; }\n\nion-col ion-img:nth-child(3n + 3) {\n  position: relative;\n  top: -82px;\n  left: 110px;\n  width: 49px;\n  height: 100%;\n  background-repeat: repeat-y;\n  background-size: 50% auto;\n  cursor: pointer; }\n\nion-col p {\n  margin-top: -60px;\n  padding-left: 20px; }\n\nion-card-title, ion-card-content {\n  text-align: center; }\n\ntable {\n  width: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _example_modal_example_modal_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../example-modal/example-modal.page */ "./src/app/example-modal/example-modal.page.ts");
...
//import { ModalPage } from './home.module';
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, http, modalController) {
    ...
    HomePage.prototype.presentModal = function (id, title) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalController.create({
                            component: _example_modal_example_modal_page__WEBPACK_IMPORTED_MODULE_1__["ExampleModalPage"],
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        ...
        var queueInterval = rxjs_Rx__WEBPACK_IMPORTED_MODULE_5__["Observable"].interval(interval).timeInterval();
        queueInterval.subscribe(function () {
            _this.load();
        });
    };
    /**
    ...
    */
    HomePage.prototype.load = function () {
        var _this = this;
        this.http
            .get('http://10.100.22.95/php/checkdatabases.php')
            .subscribe(function (data) {
            var backgroundColor = "";
            for (var i = 0; i < data.length; i++) {
                backgroundColor = (data[i] == "Accessible") ? "#92D050" : "#e54b4b";
                document.getElementsByTagName("ion-img")[3 * i + 2].style.backgroundColor = backgroundColor;
            }
        }, function (error) {
            console.dir(error);
        });
        this.http
            .get('http://10.100.22.95/php/serversname.php')
            .subscribe(function (data) {
            for (var i = 0; i < 7; i++) {
                _this.name_dev[i] = data[i];
            }
            for (var i = 7; i < data.length; i++) {
                _this.name_prod[i - 7] = data[i];
            }
        }, function (error) {
            console.dir(error);
        });
        this.http
            .get('http://10.100.22.95/php/checklogs.php')
            .subscribe(function (data) {
            var backupColor = "";
            var recreateColor = "";
            for (var i = 0; i < (data.length / 2); i++) {
                backupColor = (data[2 * i] == "Disponible") ? "#92D050" : "#e54b4b";
                recreateColor = (data[2 * i + 1] == "Disponible") ? "#92D050" : "#e54b4b";
                document.getElementsByTagName("ion-img")[3 * i + 3].style.background = "linear-gradient(180deg," + backupColor + " 40%, " + recreateColor + " 0%)";
            }
        }, function (error) {
            console.dir(error);
        });
        this.http
            .get('http://10.100.22.95/php/checkservers.php')
            .subscribe(function (data) {
            var backgroundColor = "";
            for (var i = 0; i < data.length; i++) {
                backgroundColor = (data[i] == "Accessible") ? "#92D050" : "#e54b4b";
                document.getElementsByTagName("ion-img")[3 * i + 1].style.backgroundColor = backgroundColor;
            }
        }, function (error) {
            console.dir(error);
        });
    ...
    */
    ...
    HomePage.prototype.databaseHistory = function (id) {
        var _this = this;
        this.http
            .get('http://10.100.22.95/php/availablehistory.php?id=' + id)
            .subscribe(function (data) {
            (id < 8) ? _this.presentModal(data, _this.name_dev[id - 1] + " History") : _this.presentModal(data, _this.name_prod[id - 8] + " History");
        }, function (error) {
            console.dir(error);
        });
    };
    HomePage.prototype.databaseBackups = function (event, id) {
        var _this = this;
        alert("aissa");
        var y = event.getBoundingClientRect().top;
        var ele = document.getElementById("aissa");
        var height = event.offsetHeight;
        var half = (height / 2);
        alert(y + " ele: " + height);
        //var x = //1000 - $(this).offset().top; //event.pageY
        if (y > half) {
            this.http
                .get('http://10.100.22.95/php/availablerecreatedb.php?id=' + id)
                .subscribe(function (data) {
                (id < 8) ? _this.presentModal(data, _this.name_dev[id - 1] + " Recreate database history") : _this.presentModal(data, _this.name_prod[id - 8] + " Recreate database history");
            }, function (error) {
                console.dir(error);
            });
        }
            ...
            this.http
                .get('http://10.100.22.95/php/availablebackups.php?id=' + id)
                .subscribe(function (data) {
                (id < 8) ? _this.presentModal(data, _this.name_dev[id - 1] + " Backup history") : _this.presentModal(data, _this.name_prod[id - 8] + " Backup history");
            }, function (error) {
                console.dir(error);
            });
        }
    ...
    HomePage.prototype.viewEntry = function (param) {
        this.navCtrl.navigateForward('/list/' + param);
    };
