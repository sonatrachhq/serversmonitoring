    ...
    */
    ...
    HomePage.prototype.databaseHistory = function (id) {
        ...
        this.http
            ...
            .subscribe(function (data) {
            (id < 9) ? _this.presentModal(data, _this.name_dev[id - 1] + " History") : _this.presentModal(data, _this.name_prod[id - 9] + " History");
        }, function (error) {
            console.dir(error);
        });
    };
